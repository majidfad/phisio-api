...
namespace Phisio.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260903170707_AddPatientVisitFeedback")]
    partial class AddPatientVisitFeedback
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Phisio.Domain.Entities.Article", b =>
                {
            ...
            modelBuilder.Entity("Phisio.Domain.Entities.Clinic", b =>
                {
            ...
            modelBuilder.Entity("Phisio.Domain.Entities.ClinicDoctor", b =>
                {
                    b.Property<Guid>("ClinicId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Phisio.Domain.Entities.ClinicPhoneNumber", b =>
                {
                    b.Property<Guid>("ClinicPhoneNumberId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("clinic_phone_numbers", (string)null);
                });

            modelBuilder.Entity("Phisio.Domain.Entities.DailyPatientFeedback", b =>
                {
                    b.Property<Guid>("DailyPatientFeedbackId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("DailyPatientFeedbackId");
                    ...
                    b.HasIndex("PatientId", "DoctorId", "ClinicId", "FeedbackDate")
                        .IsUnique()
            ...
            modelBuilder.Entity("Phisio.Domain.Entities.DoctorPatient", b =>
                {
                    b.Property<Guid>("DoctorId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("DoctorId", "PatientId", "ClinicId");
                    ...
                    b.HasIndex("PatientId", "DoctorId", "ClinicId")
                        .IsUnique();

                    b.ToTable("doctor_patients", (string)null);
                });
            ...
            modelBuilder.Entity("Phisio.Domain.Entities.ExerciseCategory", b =>
                {
            ...
            modelBuilder.Entity("Phisio.Domain.Entities.ExerciseCategoryLink", b =>
                {
                    b.Property<Guid>("ExerciseId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("exercise_category_links", (string)null);
                });

            modelBuilder.Entity("Phisio.Domain.Entities.ExerciseCompletion", b =>
                {
                    b.Property<Guid>("ExerciseCompletionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserExerciseId", "CompletionDate")
                        .IsUnique()
            ...
            modelBuilder.Entity("Phisio.Domain.Entities.ExerciseProgram", b =>
                {
                    ...
                    b.HasIndex("DoctorId", "PatientId", "ClinicId");

                    b.ToTable("exercise_programs", (string)null);
                });

            modelBuilder.Entity("Phisio.Domain.Entities.Notification", b =>
                {
            ...
            modelBuilder.Entity("Phisio.Domain.Entities.PatientVisit", b =>
                {
                    ...
                    b.HasIndex("ClinicId", "VisitAt");

                    b.HasIndex("DoctorId", "VisitAt");

                    b.HasIndex("PatientId", "VisitAt");

                    b.ToTable("patient_visits", (string)null);
                });

            modelBuilder.Entity("Phisio.Domain.Entities.PatientVisitFeedback", b =>
                {
                    b.Property<Guid>("PatientVisitFeedbackId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("DoctorCommunicationScore")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Phisio.Domain.Entities.PushSubscription", b =>
                {
            ...
            modelBuilder.Entity("Phisio.Domain.Entities.UserExercise", b =>
                {
                    ...
                    b.HasIndex("PatientId", "DoctorId", "ClinicId", "ExerciseId", "ScheduledDate")
                        .IsUnique()
            ...
            modelBuilder.Entity("Phisio.Infrastructure.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("ExerciseRemindersEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);
            ...
            modelBuilder.Entity("Phisio.Domain.Entities.ClinicDoctor", b =>
                {
                    b.HasOne("Phisio.Domain.Entities.Clinic", "Clinic")
            ...
            modelBuilder.Entity("Phisio.Domain.Entities.DailyPatientFeedback", b =>
                {
                    b.HasOne("Phisio.Domain.Entities.Clinic", null)
                        .WithMany()
                        .HasForeignKey("ClinicId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Phisio.Domain.Entities.ExerciseCategoryLink", b =>
                {
                    b.HasOne("Phisio.Domain.Entities.ExerciseCategory", "Category")
            ...
            modelBuilder.Entity("Phisio.Domain.Entities.PatientVisitFeedback", b =>
                {
                    b.HasOne("Phisio.Domain.Entities.PatientVisit", "Visit")
                        .WithOne()
                        .HasForeignKey("Phisio.Domain.Entities.PatientVisitFeedback", "PatientVisitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
